...
import { getDaysUntil, getSubjectColor, getSubjectLabel } from '../../utils/helpers';
  ...
  return (
    <div className="backdrop-blur-xl bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl p-5 shadow-sm dark:shadow-none">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-base font-semibold text-gray-900 dark:text-white">{t('dashboard.upcomingDeadlines')}</h3>
      </div>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-400 dark:text-white/40">
                    {getSubjectLabel(event.subject)} · {t(`planner.typeLabels.${event.type}`)}
                  </p>
                </div>
