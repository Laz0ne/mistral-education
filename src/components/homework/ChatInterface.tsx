  ...
  return (
    <div className="flex flex-col h-full">
          ...
          <div className="flex flex-wrap gap-2">
            {QUICK_SUGGESTIONS.map((suggestion) => (
              <motion.button
                ...
                className="text-xs px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-white/60 hover:text-white hover:border-[#F7931A]/40 hover:bg-[#F7931A]/5 transition-all"
              >
                {suggestion}
              </motion.button>
            ))}
      ...
      <div className="p-4 border-t border-white/5">
        <div className="flex items-end gap-2 bg-white/5 border border-white/10 rounded-2xl px-3 py-2 focus-within:border-[#F7931A]/40 transition-colors">
          <FileUpload />
          <textarea
            ref={inputRef}
            value={inputValue}
            ...
            rows={1}
            className="flex-1 bg-transparent text-sm text-white placeholder-white/30 resize-none focus:outline-none py-1.5 max-h-32 scrollbar-thin"
