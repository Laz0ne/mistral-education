...
export const Header: React.FC = () => {
  ...
  return (
    <header className="h-16 flex items-center justify-between px-6 border-b border-white/5 bg-[#0A0A0B]/50 backdrop-blur-sm sticky top-0 z-30">
      <h1 className="text-lg font-semibold text-white lg:block hidden">{title}</h1>
